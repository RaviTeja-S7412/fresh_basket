                                        ...
                                        <tbody>
                                           ...
                                           <?php if($u->deleted==0){ ?>
                                            <tr>
                                                ...
                                                <!-- <td style="padding: 0.5rem;"><?php //echo $u->brandname ?></td> -->
                                               ...
                                               <div class="switch">
                                                ...
                                                <td style="padding: 0.5rem;">
                                                    <a href="<?php echo base_url() ?>products/edit-product/<?php echo $u->id ?>" class="text-inverse p-r-10" target="_blank"><i class="ti-marker-alt"></i></a>
