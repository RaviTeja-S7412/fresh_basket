...
class Mobile_api extends REST_Controller
{
	...
	public function check_forgototp_post()
	{
		...
		$data = $this->user_model->checkforgot_otp($num, $otp);
		if ($data['status']) {
			$this->response($data, REST_Controller::HTTP_OK);
		} else {
			$this->response($data, REST_Controller::HTTP_OK);
	...
	public function checkotp_post()
	{
		...
		$data = $this->user_model->check_otp($num, $otp);
		if ($data['status']) {
			$this->response($data, REST_Controller::HTTP_OK);
		} else {
			$this->response($data, REST_Controller::HTTP_OK);
	...
	public function register_post()
	{
		...
		$data = $this->user_model->register($this->input->post());
		if ($data['status']) {
			$this->response($data, REST_Controller::HTTP_OK);
		} else {
			$this->response($data, REST_Controller::HTTP_OK);
	...
	public function passwordupdate_post()
	{
		...
		$data = $this->user_model->password_update($this->input->post());
		if ($data['status']) {
			$this->response($data, REST_Controller::HTTP_OK);
		} else {
			$this->response($data, REST_Controller::HTTP_OK);
	...
	public function dashboard_post()
	{
		...
		$uid = $this->input->post("userid");
		$data = $this->user_model->dashboard_data($uid);
		if ($data['status']) {
			$this->response($data, REST_Controller::HTTP_OK);
		} else {
			$this->response($data, REST_Controller::HTTP_OK);
